...
def main(args):
    ...
    metric = evaluate.load(
        "seqeval", experiment_id=process_id, cache_dir=model_args.cache_dir
    )
    ...
    logger.warning("Logging Folder is {0}".format(model_args.log_dir))
    logger.warning("Process Id is {0}".format(process_id))
    ...
    trainer = Trainer(
        ...
        callbacks=[early_stopping_callback, aim_callback]
